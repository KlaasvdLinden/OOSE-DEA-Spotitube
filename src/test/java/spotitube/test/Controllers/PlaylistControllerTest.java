...
import oose.dea.spotitube.klaasvanderlinden.Controllers.PlaylistController.PlaylistController;
...
public class PlaylistControllerTest {
    ...
    public void setup(){
        ...
        Mockito.when(playlistService.getPlaylists()).thenReturn(playlists);
    }
